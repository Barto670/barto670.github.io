skills = [
                ...
                { name:'JavaScript',     dateStarted: '2019-01-01',      color:'#D3B62A35',      imageLink:'./images/skills/js.png'},
                ...
                { name:'C++',            dateStarted: '2022-01-01',      color:'#00599C35',      imageLink:'./images/skills/c++.png'},
                { name:'Arduino',        dateStarted: '2022-01-01',      color:'#2D929635',      imageLink:'./images/skills/arduino.png'},
                { name:'Android',        dateStarted: '2023-01-01',      color:'#98C42535',      imageLink:'./images/skills/android.png'},
                { name:'C',              dateStarted: '2023-01-01',      color:'#00599C35',      imageLink:'./images/skills/c.png'},
        ]

projects = [
                { name:'CS2 Stash Enhancer',              statusColor:'green' ,       bigImagesrc:'./images/projects/cs2stashenhancerbig.png',       smallImagesrc: './images/projects/cs2stashenhancersmall.png' ,      status:'Online' ,        tag1:'Extention',       tag2:'HTML',            tag3:'JavaScript' ,  redirectionURLStyle:'flex',  redirectionURL:'https://chromewebstore.google.com/detail/cs2-stash-enhancer/foacepfkmbckfdnbgmphekpbamedhmjj?hl=en',       expandURL:'' ,     description:'Browser Extension for a video game called Counter Strike 2. This extension works on the website csgostash.com and gives any user an experience with an expanded libary of useful features.'},
                { name:'Online Shop Website',             statusColor:'orange' ,      bigImagesrc:'./images/projects/dashShopBig.png',               smallImagesrc: './images/projects/dashShopSmall.png' ,              status:'Concept' ,       tag1:'HTML',            tag2:'CSS',             tag3:'JavaScript' ,  redirectionURLStyle:'none',   redirectionURL:'',                                                                                                         expandURL:'' ,     description:'A sample website that was created as part of the portfolio. This website demonstrates how a shop website could function both from the staff view and the customer view.'},
                { name:'UL Student Guide',                statusColor:'orange' ,      bigImagesrc:'./images/projects/studentguideBig.png',           smallImagesrc: './images/projects/studentguideSmall.png' ,          status:'Concept' ,       tag1:'Android',         tag2:'Application',     tag3:'Java' ,        redirectionURLStyle:'none',   redirectionURL:'',                                                                                                         expandURL:'' ,     description:'A project made for final year of my Masters. This application is a student guide that is targetted towards new & erasmus students to get familiar with the UL Campus.'},
                { name:'DoneDeal Discord Bot',            statusColor:'orange' ,      bigImagesrc:'./images/projects/donedealBig.png',               smallImagesrc: './images/projects/donedealSmall.png' ,              status:'Concept' ,       tag1:'Bot',             tag2:'Discord',         tag3:'Python' ,      redirectionURLStyle:'none',   redirectionURL:'',                                                                                                         expandURL:'' ,     description:'A bot made for a motor marketplace DoneDeal.ie made in python. Get discord notifications on cars based on the inputted filters. Messages are sent to a selected discord channel when a new car listing is created.'},
